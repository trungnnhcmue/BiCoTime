...
import numpy as np
from utils import complex_mul, get_param
...
class BiCoTime(TKBCModel):
    def __init__(self, sizes: Tuple[int, int, int], rank: int, init_size: float = 1e-3):
        super(BiCoTime).__init__()
        #The source code will be made available after the initial round of review is completed.
